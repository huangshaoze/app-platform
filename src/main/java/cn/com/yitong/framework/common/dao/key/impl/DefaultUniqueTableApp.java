...
import cn.com.yitong.framework.common.dao.key.CacheValue;
import cn.com.yitong.framework.common.dao.key.UniqueException;
import cn.com.yitong.framework.common.dao.key.UniqueTableApp;
...
public class DefaultUniqueTableApp implements UniqueTableApp {
	...
	public DefaultUniqueTableApp(DataSource dataSource) {
		...
		this.selectSQL = "SELECT code FROM YITONG_PRIMARYKEY WHERE name = ? FOR UPDATE";
