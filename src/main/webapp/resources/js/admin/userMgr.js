...
var USER_GRID_STORE_URL = CONTEXT_PATH + '/user/pageQueryUsers.json'; //用户列表
var USER_ROLE_GRID_STORE_URL = CONTEXT_PATH + '/user/getAllRolesByUserId';//根据用户信息查询该用户所属角色
var USER_ROLE_RELATION_STORE_URL = CONTEXT_PATH + '/user/pageQueryRoles4User.json';//用户授予角色时显示的角色关系列表
...
Ext.define('UserInfoForm', {
    ...
    addFormClick : function() {
    	 ...
    	 if(thisForm.isValid()) {
    		 thisForm.submit({
                 waitMsg: '正在提交数据...',
                 url: CONTEXT_PATH + '/user/insertUser', 
                 params:{orgId:orgId},
                 method: 'POST',
